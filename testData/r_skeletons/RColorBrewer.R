##
## Exported symobls in package `RColorBrewer`
##

## Exported package methods

brewer.pal.info <- structure(list(maxcolors = c(11, 11, 11, 11, 11, 11, 11, 11, 
11, 8, 8, 12, 9, 8, 9, 8, 12, 9, 9, 9, 9, 9, 9, 9, 9, 9, 9, 9, 
9, 9, 9, 9, 9, 9, 9), category = structure(c(1L, 1L, 1L, 1L, 
1L, 1L, 1L, 1L, 1L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 3L, 3L, 3L, 
3L, 3L, 3L, 3L, 3L, 3L, 3L, 3L, 3L, 3L, 3L, 3L, 3L, 3L, 3L), .Label = c("div", 
"qual", "seq"), class = "factor"), colorblind = c(TRUE, TRUE, 
TRUE, TRUE, TRUE, FALSE, TRUE, FALSE, FALSE, FALSE, TRUE, TRUE, 
FALSE, FALSE, FALSE, TRUE, FALSE, TRUE, TRUE, TRUE, TRUE, TRUE, 
TRUE, TRUE, TRUE, TRUE, TRUE, TRUE, TRUE, TRUE, TRUE, TRUE, TRUE, 
TRUE, TRUE)), .Names = c("maxcolors", "category", "colorblind"
), row.names = c("BrBG", "PiYG", "PRGn", "PuOr", "RdBu", "RdGy", 
"RdYlBu", "RdYlGn", "Spectral", "Accent", "Dark2", "Paired", 
"Pastel1", "Pastel2", "Set1", "Set2", "Set3", "Blues", "BuGn", 
"BuPu", "GnBu", "Greens", "Greys", "Oranges", "OrRd", "PuBu", 
"PuBuGn", "PuRd", "Purples", "RdPu", "Reds", "YlGn", "YlGnBu", 
"YlOrBr", "YlOrRd"), class = "data.frame")
...
display.brewer.all <- function (n = NULL, type = "all", select = NULL, exact.n = TRUE, 
...
display.brewer.pal <- function (n, name) 
{
    ...
    if (n > maxcolors[which(name == namelist)]) {
        ...
        return(display.brewer.pal(maxcolors[which(name == namelist)], 
            name))
    }
    if (length(which(name == quallist)) > 0) 
        palattr <- "(qualitative)"
    if (length(which(name == divlist)) > 0) 
        palattr <- "(divergent)"
    if (length(which(name == seqlist)) > 0) 
        palattr <- "(sequential)"
...
.skeleton_package_title = "ColorBrewer Palettes"
