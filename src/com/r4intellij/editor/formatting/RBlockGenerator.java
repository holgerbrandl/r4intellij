...
import com.r4intellij.editor.formatting.processor.RIndentProcessor;
 ...
 */
public class RBlockGenerator implements RTypes {
    ...
    public static List<Block> generateSubBlocks(ASTNode node,
                                                ...
                                                RBlock block) {
        Wrap myWrap = _myWrap;
        CodeStyleSettings mySettings = _mySettings;
        Alignment myAlignment = _myAlignment;
        ...
        for (ASTNode childNode : children) {
            if (canBeCorrectBlock(childNode)) {
                ...
                subBlocks.add(new RBlock(childNode, myAlignment, indent, myWrap, mySettings));
